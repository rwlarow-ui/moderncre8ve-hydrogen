/**
 * Placeholder media referenced by section `presets` and used as a fallback when
 * an image field has never been filled in.
 *
 * Values are the Shopify-hosted FPO assets the storefront already shipped with.
 */
